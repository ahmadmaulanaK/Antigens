                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">
                                Antigen JABODETABEK
                                <a href="{{ route('jabodetabek.create') }}" class="btn btn-primary btn-sm float-right"><i class="fa fa-magic"></i>&nbsp;Tambah</a>|
                              <a href="/jabodetabek/export">Laporan</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td>
                                               ...
                                               <a href="/jabodetabek/show/{{Crypt::encrypt($row->id)}}" class="btn btn-success btn-sm shadow "><i class="nav-icon icon-share"> SHARE </i></a>
