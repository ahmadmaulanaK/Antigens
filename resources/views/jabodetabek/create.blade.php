                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" name="address" aria-label="With textarea"
                                        value="{{ old('address') }}" >{{ old('address') }}</textarea> <p class="text-danger">{{ $errors->first('address') }}</p>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="pelayanan" class="form-control" >
                                        ...
                                        <option value="Home Visit " {{ old('pelayanan') == 'Home Visit' ? 'selected':'' }}>Home Visit
                                        </option>
                                        <option value="Drive THRU" {{ old('pelayanan') == 'Drive THRU' ? 'selected':'' }}>Drive THRU
                                        </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 col-form-label">
                                        ...
                                        <div class="form-check form-check-inline mr-1">
                                            <input class="form-check-input" type="radio" id="inline-radio2"
                                                value="H(+1)"name="hasil" {{ old('hasil')=="H(+1)" ? 'checked='.'"checked"' : '' }} >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                    <select id="multiple-select" name="spesimen" class="form-control" size="5" multiple="" >
                                    <option value="Nasal" {{ old('spesimen') == 'Nasal' ? 'selected':'' }}>Nasal</option>
                                    <option value="Darah" {{ old('spesimen') == 'Darah' ? 'selected':'' }}>Darah</option>
                                    <option value="Swab Nasofaring" {{ old('spesimen') == 'Swab Nasofaring' ? 'selected':'' }}>Swab Nasofaring</option>
                                    <option value="Swab Orofaring" {{ old('spesimen') == 'Swab Orofaring' ? 'selected':'' }}>Swab Orofaring</option>
                                    <option value="Swab Orofaring&Nasofaring" {{ old('spesimen') == 'Swab Orofaring&Nasofaring' ? 'selected':'' }}>Swab Orofaring&Nasofaring</option>
