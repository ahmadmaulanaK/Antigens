...
<body>
    <div class="book">
        ...
        <div class="page">
            ...
            <div style="" class="mt-2 bg-warning">
                <h4 class="text-center" style="color:rgb(255, 255, 255);">LAPORAN HARIAN ANTIGEN JABODETABEK
                </h4>
            </div>
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="callout callout-warning">
                      <small class="text-muted">Tes ({{ $val->name }})</small>
                      <br>
              ...
              </li><!-- end ngRepeat: row in data --><!-- end ngRepeat: row in data -->
              @endforeach
            </ul>
            </div>
            <!--/.col-->
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="callout callout-danger">
                      <small class="text-muted">Hasil ({{ $val->hasil }})</small>
                      <br>
...
@endforelse<!-- end ngRepeat: row in gender -->
 ...
 <tr ng-repeat="user in users" class="ng-scope">
    ...
    <td>
      ...
      <div class="small text-muted ng-binding">
        <!-- ngIf: user.new == true --><span ng-if="user.new == true" class="ng-scope">Termasuk Pembayaran</span><!-- end ngIf: user.new == true -->
        <!-- ngIf: user.new == false -->
    ...
    <td>
      <div class="clearfix">
        <div class="float-left">
          <strong class="ng-binding">Rp. {{number_format($item->jml_harga)}}</strong>
        </div>
        <div class="float-right">
...
@forelse($jml_harga_all as $item)
              ...
              <tr ng-repeat="user in users" class="ng-scope">
                ...
                <td>
                  <div class="clearfix">
                    <div class="float-left">
                      <strong class="ng-binding">Rp. {{number_format($item->jml_harga_1)}}</strong>
                    </div>
                    <div class="float-right">
                      <small class="text-muted ng-binding">{{$nowTimeDate,true}}</small>
                    </div>
              ...
              <tr ng-repeat="user in users" class="ng-scope">
                ...
                <td>
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <small class="text-muted ng-binding">Jun 11, 2015 - Jul 10, 2015</small>
                    </div>
                  </div>
                  <div class="progress progress-xs">
                    <div class="progress-bar bg-success" ng-class="{ 'bg-info'    : user.usage <= 25,
