    ...
    <div style="">
           ...
           <table style="width:100%" class="mt-1" >
            ...
            <tr>
             ...
             <td valign="top">:</td>
             <td style="border-style: inset;background-color: #ecd719;" >Rp. {{ number_format($antigen->cash) }}</td>
           ...
           <div class="row mt-4">
               <div class="col-4" style="border-style: inset;background-color: #ecd719;">Jumlah : Rp. {{ number_format($antigen->cash) }}</div>
               <div class="col-3" ></div>
